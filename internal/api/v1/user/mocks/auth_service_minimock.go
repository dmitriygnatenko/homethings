...
// AuthServiceMock implements mm_user.AuthService
type AuthServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcGeneratePasswordHash          func(password string) (s1 string, err error)
	funcGeneratePasswordHashOrigin    string
...
// NewAuthServiceMock returns a mock for mm_user.AuthService
...
type AuthServiceMockGeneratePasswordHashExpectation struct {
	...
	expectationOrigins AuthServiceMockGeneratePasswordHashExpectationOrigins
...
// AuthServiceMockGeneratePasswordHashOrigins contains origins of expectations of the AuthService.GeneratePasswordHash
type AuthServiceMockGeneratePasswordHashExpectationOrigins struct {
	origin         string
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) Expect(password string) *mAuthServiceMockGeneratePasswordHash {
	...
	mmGeneratePasswordHash.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) ExpectPasswordParam1(password string) *mAuthServiceMockGeneratePasswordHash {
	...
	mmGeneratePasswordHash.defaultExpectation.expectationOrigins.originPassword = minimock.CallerInfo(1)
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) Return(s1 string, err error) *AuthServiceMock {
	...
	mmGeneratePasswordHash.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) Set(f func(password string) (s1 string, err error)) *AuthServiceMock {
	...
	mmGeneratePasswordHash.mock.funcGeneratePasswordHashOrigin = minimock.CallerInfo(1)
	return mmGeneratePasswordHash.mock
}
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) When(password string) *AuthServiceMockGeneratePasswordHashExpectation {
	...
	expectation := &AuthServiceMockGeneratePasswordHashExpectation{
		...
		expectationOrigins: AuthServiceMockGeneratePasswordHashExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGeneratePasswordHash *mAuthServiceMockGeneratePasswordHash) Times(n uint64) *mAuthServiceMockGeneratePasswordHash {
	...
	mmGeneratePasswordHash.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGeneratePasswordHash
}
...
// GeneratePasswordHash implements mm_user.AuthService
func (mmGeneratePasswordHash *AuthServiceMock) GeneratePasswordHash(password string) (s1 string, err error) {
	...
	mmGeneratePasswordHash.t.Helper()
	...
	if mmGeneratePasswordHash.GeneratePasswordHashMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.password != nil && !minimock.Equal(*mm_want_ptrs.password, mm_got.password) {
				mmGeneratePasswordHash.t.Errorf("AuthServiceMock.GeneratePasswordHash got unexpected parameter password, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGeneratePasswordHash.GeneratePasswordHashMock.defaultExpectation.expectationOrigins.originPassword, *mm_want_ptrs.password, mm_got.password, minimock.Diff(*mm_want_ptrs.password, mm_got.password))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGeneratePasswordHash.t.Errorf("AuthServiceMock.GeneratePasswordHash got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGeneratePasswordHash.GeneratePasswordHashMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *AuthServiceMock) MinimockGeneratePasswordHashInspect() {
	for _, e := range m.GeneratePasswordHashMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AuthServiceMock.GeneratePasswordHash at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GeneratePasswordHashMock.defaultExpectation != nil && afterGeneratePasswordHashCounter < 1 {
		if m.GeneratePasswordHashMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to AuthServiceMock.GeneratePasswordHash at\n%s", m.GeneratePasswordHashMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to AuthServiceMock.GeneratePasswordHash at\n%s with params: %#v", m.GeneratePasswordHashMock.defaultExpectation.expectationOrigins.origin, *m.GeneratePasswordHashMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGeneratePasswordHash != nil && afterGeneratePasswordHashCounter < 1 {
		m.t.Errorf("Expected call to AuthServiceMock.GeneratePasswordHash at\n%s", m.funcGeneratePasswordHashOrigin)
	}

	if !m.GeneratePasswordHashMock.invocationsDone() && afterGeneratePasswordHashCounter > 0 {
		m.t.Errorf("Expected %d calls to AuthServiceMock.GeneratePasswordHash at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GeneratePasswordHashMock.expectedInvocations), m.GeneratePasswordHashMock.expectedInvocationsOrigin, afterGeneratePasswordHashCounter)
	}
}
...
func (mmGetClaims *mAuthServiceMockGetClaims) ExpectFctxParam1(fctx *fiber.Ctx) *mAuthServiceMockGetClaims {
	...
	mmGetClaims.defaultExpectation.expectationOrigins.originFctx = minimock.CallerInfo(1)
...
// GetClaims implements mm_user.AuthService
	...
	if mmGetClaims.GetClaimsMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fctx != nil && !minimock.Equal(*mm_want_ptrs.fctx, mm_got.fctx) {
				mmGetClaims.t.Errorf("AuthServiceMock.GetClaims got unexpected parameter fctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetClaims.GetClaimsMock.defaultExpectation.expectationOrigins.originFctx, *mm_want_ptrs.fctx, mm_got.fctx, minimock.Diff(*mm_want_ptrs.fctx, mm_got.fctx))
			}
