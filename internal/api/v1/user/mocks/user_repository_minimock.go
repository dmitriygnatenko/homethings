...
//go:generate minimock -i github.com/dmitriygnatenko/homethings-v1/internal/api/v1/user.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMockAddExpectation struct {
	...
	expectationOrigins UserRepositoryMockAddExpectationOrigins
...
// UserRepositoryMockAddOrigins contains origins of expectations of the UserRepository.Add
type UserRepositoryMockAddExpectationOrigins struct {
	origin         string
	originCtx      string
...
func (mmAdd *mUserRepositoryMockAdd) ExpectUsernameParam2(username string) *mUserRepositoryMockAdd {
	...
	mmAdd.defaultExpectation.expectationOrigins.originUsername = minimock.CallerInfo(1)
...
func (mmAdd *mUserRepositoryMockAdd) ExpectPasswordParam3(password string) *mUserRepositoryMockAdd {
	...
	mmAdd.defaultExpectation.expectationOrigins.originPassword = minimock.CallerInfo(1)
...
func (mmAdd *mUserRepositoryMockAdd) When(ctx context.Context, username string, password string) *UserRepositoryMockAddExpectation {
	...
	expectation := &UserRepositoryMockAddExpectation{
		...
		expectationOrigins: UserRepositoryMockAddExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Add implements mm_user.UserRepository
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmAdd.t.Errorf("UserRepositoryMock.Add got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.username != nil && !minimock.Equal(*mm_want_ptrs.username, mm_got.username) {
				mmAdd.t.Errorf("UserRepositoryMock.Add got unexpected parameter username, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmAdd.AddMock.defaultExpectation.expectationOrigins.originUsername, *mm_want_ptrs.username, mm_got.username, minimock.Diff(*mm_want_ptrs.username, mm_got.username))
			}

			if mm_want_ptrs.password != nil && !minimock.Equal(*mm_want_ptrs.password, mm_got.password) {
				mmAdd.t.Errorf("UserRepositoryMock.Add got unexpected parameter password, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmAdd.AddMock.defaultExpectation.expectationOrigins.originPassword, *mm_want_ptrs.password, mm_got.password, minimock.Diff(*mm_want_ptrs.password, mm_got.password))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmAdd.t.Errorf("UserRepositoryMock.Add got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *UserRepositoryMock) MinimockAddInspect() {
	for _, e := range m.AddMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.Add at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.AddMock.invocationsDone() && afterAddCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.Add at\n%s but found %d calls",
...
func (mmGet *mUserRepositoryMockGet) ExpectUsernameParam2(username string) *mUserRepositoryMockGet {
	...
	mmGet.defaultExpectation.expectationOrigins.originUsername = minimock.CallerInfo(1)
...
// Get implements mm_user.UserRepository
func (mmGet *UserRepositoryMock) Get(ctx context.Context, username string) (up1 *models.User, err error) {
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.username != nil && !minimock.Equal(*mm_want_ptrs.username, mm_got.username) {
				mmGet.t.Errorf("UserRepositoryMock.Get got unexpected parameter username, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGet.GetMock.defaultExpectation.expectationOrigins.originUsername, *mm_want_ptrs.username, mm_got.username, minimock.Diff(*mm_want_ptrs.username, mm_got.username))
			}
...
// Update implements mm_user.UserRepository
