...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/user.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
