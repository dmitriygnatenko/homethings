...
//go:generate minimock -i github.com/dmitriygnatenko/homethings-v1/internal/api/v1/thing.ThingTagRepository -o thing_tag_repository_minimock.go -n ThingTagRepositoryMock -p mocks
