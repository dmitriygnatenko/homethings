...
//go:generate minimock -i github.com/dmitriygnatenko/homethings-v1/internal/api/v1/image.TransactionManager -o transaction_manager_minimock.go -n TransactionManagerMock -p mocks
...
// TransactionManagerMock implements mm_image.TransactionManager
...
// NewTransactionManagerMock returns a mock for mm_image.TransactionManager
...
// ReadCommitted implements mm_image.TransactionManager
