...
// FileRepositoryMock implements mm_image.FileRepository
...
// NewFileRepositoryMock returns a mock for mm_image.FileRepository
...
type FileRepositoryMockDeleteExpectation struct {
	...
	expectationOrigins FileRepositoryMockDeleteExpectationOrigins
...
// FileRepositoryMockDeleteOrigins contains origins of expectations of the FileRepository.Delete
type FileRepositoryMockDeleteExpectationOrigins struct {
	origin     string
	originPath string
}
...
func (mmDelete *mFileRepositoryMockDelete) ExpectPathParam1(path string) *mFileRepositoryMockDelete {
	...
	mmDelete.defaultExpectation.expectationOrigins.originPath = minimock.CallerInfo(1)
...
func (mmDelete *mFileRepositoryMockDelete) When(path string) *FileRepositoryMockDeleteExpectation {
	...
	expectation := &FileRepositoryMockDeleteExpectation{
		...
		expectationOrigins: FileRepositoryMockDeleteExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Delete implements mm_image.FileRepository
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.path != nil && !minimock.Equal(*mm_want_ptrs.path, mm_got.path) {
				mmDelete.t.Errorf("FileRepositoryMock.Delete got unexpected parameter path, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDelete.DeleteMock.defaultExpectation.expectationOrigins.originPath, *mm_want_ptrs.path, mm_got.path, minimock.Diff(*mm_want_ptrs.path, mm_got.path))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDelete.t.Errorf("FileRepositoryMock.Delete got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *FileRepositoryMock) MinimockDeleteInspect() {
	for _, e := range m.DeleteMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to FileRepositoryMock.Delete at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.DeleteMock.invocationsDone() && afterDeleteCounter > 0 {
		m.t.Errorf("Expected %d calls to FileRepositoryMock.Delete at\n%s but found %d calls",
...
type FileRepositoryMockSaveExpectation struct {
	...
	expectationOrigins FileRepositoryMockSaveExpectationOrigins
...
// FileRepositoryMockSaveOrigins contains origins of expectations of the FileRepository.Save
type FileRepositoryMockSaveExpectationOrigins struct {
	origin       string
	originFctx   string
	originHeader string
	originPath   string
...
func (mmSave *mFileRepositoryMockSave) ExpectFctxParam1(fctx *fiber.Ctx) *mFileRepositoryMockSave {
	...
	mmSave.defaultExpectation.expectationOrigins.originFctx = minimock.CallerInfo(1)
...
func (mmSave *mFileRepositoryMockSave) ExpectHeaderParam2(header *multipart.FileHeader) *mFileRepositoryMockSave {
	...
	mmSave.defaultExpectation.expectationOrigins.originHeader = minimock.CallerInfo(1)
...
func (mmSave *mFileRepositoryMockSave) ExpectPathParam3(path string) *mFileRepositoryMockSave {
	...
	mmSave.defaultExpectation.expectationOrigins.originPath = minimock.CallerInfo(1)
...
func (mmSave *mFileRepositoryMockSave) When(fctx *fiber.Ctx, header *multipart.FileHeader, path string) *FileRepositoryMockSaveExpectation {
	...
	expectation := &FileRepositoryMockSaveExpectation{
		...
		expectationOrigins: FileRepositoryMockSaveExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Save implements mm_image.FileRepository
	...
	if mmSave.SaveMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fctx != nil && !minimock.Equal(*mm_want_ptrs.fctx, mm_got.fctx) {
				mmSave.t.Errorf("FileRepositoryMock.Save got unexpected parameter fctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSave.SaveMock.defaultExpectation.expectationOrigins.originFctx, *mm_want_ptrs.fctx, mm_got.fctx, minimock.Diff(*mm_want_ptrs.fctx, mm_got.fctx))
			}

			if mm_want_ptrs.header != nil && !minimock.Equal(*mm_want_ptrs.header, mm_got.header) {
				mmSave.t.Errorf("FileRepositoryMock.Save got unexpected parameter header, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSave.SaveMock.defaultExpectation.expectationOrigins.originHeader, *mm_want_ptrs.header, mm_got.header, minimock.Diff(*mm_want_ptrs.header, mm_got.header))
			}

			if mm_want_ptrs.path != nil && !minimock.Equal(*mm_want_ptrs.path, mm_got.path) {
				mmSave.t.Errorf("FileRepositoryMock.Save got unexpected parameter path, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSave.SaveMock.defaultExpectation.expectationOrigins.originPath, *mm_want_ptrs.path, mm_got.path, minimock.Diff(*mm_want_ptrs.path, mm_got.path))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSave.t.Errorf("FileRepositoryMock.Save got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *FileRepositoryMock) MinimockSaveInspect() {
	for _, e := range m.SaveMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to FileRepositoryMock.Save at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.SaveMock.invocationsDone() && afterSaveCounter > 0 {
		m.t.Errorf("Expected %d calls to FileRepositoryMock.Save at\n%s but found %d calls",
