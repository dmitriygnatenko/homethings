...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/auth.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
