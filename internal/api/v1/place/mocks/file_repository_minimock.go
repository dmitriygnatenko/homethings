...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/place.FileRepository -o file_repository_minimock.go -n FileRepositoryMock -p mocks
