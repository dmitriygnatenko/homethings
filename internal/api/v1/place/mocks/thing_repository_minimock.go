...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/place.ThingRepository -o thing_repository_minimock.go -n ThingRepositoryMock -p mocks
