...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/place.ThingImageRepository -o thing_image_repository_minimock.go -n ThingImageRepositoryMock -p mocks
