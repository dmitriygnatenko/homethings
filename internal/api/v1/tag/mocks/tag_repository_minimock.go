...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/tag.TagRepository -o tag_repository_minimock.go -n TagRepositoryMock -p mocks
