...
//go:generate minimock -i github.com/dmitriygnatenko/homethings-v1/internal/api/v1/tag.TransactionManager -o transaction_manager_minimock.go -n TransactionManagerMock -p mocks
...
// TransactionManagerMock implements mm_tag.TransactionManager
...
// NewTransactionManagerMock returns a mock for mm_tag.TransactionManager
...
// ReadCommitted implements mm_tag.TransactionManager
