...
//go:generate minimock -i github.com/dmitriygnatenko/homethings-v1/internal/api/v1/tag.ThingTagRepository -o thing_tag_repository_minimock.go -n ThingTagRepositoryMock -p mocks
...
// ThingTagRepositoryMock implements mm_tag.ThingTagRepository
type ThingTagRepositoryMock struct {
	...
	funcDeleteByTagIDOrigin    string
...
// NewThingTagRepositoryMock returns a mock for mm_tag.ThingTagRepository
...
type ThingTagRepositoryMockAddExpectation struct {
	...
	expectationOrigins ThingTagRepositoryMockAddExpectationOrigins
...
// ThingTagRepositoryMockAddOrigins contains origins of expectations of the ThingTagRepository.Add
type ThingTagRepositoryMockAddExpectationOrigins struct {
	origin    string
	originCtx string
	originReq string
}
...
func (mmAdd *mThingTagRepositoryMockAdd) When(ctx context.Context, req models.AddThingTagRequest) *ThingTagRepositoryMockAddExpectation {
	...
	expectation := &ThingTagRepositoryMockAddExpectation{
		...
		expectationOrigins: ThingTagRepositoryMockAddExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Add implements mm_tag.ThingTagRepository
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmAdd.t.Errorf("ThingTagRepositoryMock.Add got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmAdd.t.Errorf("ThingTagRepositoryMock.Add got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmAdd.t.Errorf("ThingTagRepositoryMock.Add got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *ThingTagRepositoryMock) MinimockAddInspect() {
	for _, e := range m.AddMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ThingTagRepositoryMock.Add at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.AddMock.invocationsDone() && afterAddCounter > 0 {
		m.t.Errorf("Expected %d calls to ThingTagRepositoryMock.Add at\n%s but found %d calls",
...
type ThingTagRepositoryMockDeleteExpectation struct {
	...
	expectationOrigins ThingTagRepositoryMockDeleteExpectationOrigins
...
// ThingTagRepositoryMockDeleteOrigins contains origins of expectations of the ThingTagRepository.Delete
type ThingTagRepositoryMockDeleteExpectationOrigins struct {
	origin    string
	originCtx string
	originReq string
}
...
func (mmDelete *mThingTagRepositoryMockDelete) ExpectReqParam2(req models.DeleteThingTagRequest) *mThingTagRepositoryMockDelete {
	...
	mmDelete.defaultExpectation.expectationOrigins.originReq = minimock.CallerInfo(1)
...
func (mmDelete *mThingTagRepositoryMockDelete) When(ctx context.Context, req models.DeleteThingTagRequest) *ThingTagRepositoryMockDeleteExpectation {
	...
	expectation := &ThingTagRepositoryMockDeleteExpectation{
		...
		expectationOrigins: ThingTagRepositoryMockDeleteExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Delete implements mm_tag.ThingTagRepository
func (mmDelete *ThingTagRepositoryMock) Delete(ctx context.Context, req models.DeleteThingTagRequest) (err error) {
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDelete.t.Errorf("ThingTagRepositoryMock.Delete got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDelete.DeleteMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmDelete.t.Errorf("ThingTagRepositoryMock.Delete got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDelete.DeleteMock.defaultExpectation.expectationOrigins.originReq, *mm_want_ptrs.req, mm_got.req, minimock.Diff(*mm_want_ptrs.req, mm_got.req))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDelete.t.Errorf("ThingTagRepositoryMock.Delete got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *ThingTagRepositoryMock) MinimockDeleteInspect() {
	for _, e := range m.DeleteMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ThingTagRepositoryMock.Delete at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.DeleteMock.invocationsDone() && afterDeleteCounter > 0 {
		m.t.Errorf("Expected %d calls to ThingTagRepositoryMock.Delete at\n%s but found %d calls",
...
type ThingTagRepositoryMockDeleteByTagIDExpectation struct {
	...
	expectationOrigins ThingTagRepositoryMockDeleteByTagIDExpectationOrigins
...
// ThingTagRepositoryMockDeleteByTagIDOrigins contains origins of expectations of the ThingTagRepository.DeleteByTagID
type ThingTagRepositoryMockDeleteByTagIDExpectationOrigins struct {
	origin    string
	originCtx string
	originId  string
}
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) Expect(ctx context.Context, id uint64) *mThingTagRepositoryMockDeleteByTagID {
	...
	mmDeleteByTagID.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) ExpectCtxParam1(ctx context.Context) *mThingTagRepositoryMockDeleteByTagID {
	...
	mmDeleteByTagID.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) ExpectIdParam2(id uint64) *mThingTagRepositoryMockDeleteByTagID {
	...
	mmDeleteByTagID.defaultExpectation.expectationOrigins.originId = minimock.CallerInfo(1)
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) Return(err error) *ThingTagRepositoryMock {
	...
	mmDeleteByTagID.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) Set(f func(ctx context.Context, id uint64) (err error)) *ThingTagRepositoryMock {
	...
	mmDeleteByTagID.mock.funcDeleteByTagIDOrigin = minimock.CallerInfo(1)
	return mmDeleteByTagID.mock
}
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) When(ctx context.Context, id uint64) *ThingTagRepositoryMockDeleteByTagIDExpectation {
	...
	expectation := &ThingTagRepositoryMockDeleteByTagIDExpectation{
		...
		expectationOrigins: ThingTagRepositoryMockDeleteByTagIDExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmDeleteByTagID *mThingTagRepositoryMockDeleteByTagID) Times(n uint64) *mThingTagRepositoryMockDeleteByTagID {
	...
	mmDeleteByTagID.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmDeleteByTagID
}
...
// DeleteByTagID implements mm_tag.ThingTagRepository
func (mmDeleteByTagID *ThingTagRepositoryMock) DeleteByTagID(ctx context.Context, id uint64) (err error) {
	...
	if mmDeleteByTagID.DeleteByTagIDMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDeleteByTagID.t.Errorf("ThingTagRepositoryMock.DeleteByTagID got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteByTagID.DeleteByTagIDMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmDeleteByTagID.t.Errorf("ThingTagRepositoryMock.DeleteByTagID got unexpected parameter id, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteByTagID.DeleteByTagIDMock.defaultExpectation.expectationOrigins.originId, *mm_want_ptrs.id, mm_got.id, minimock.Diff(*mm_want_ptrs.id, mm_got.id))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteByTagID.t.Errorf("ThingTagRepositoryMock.DeleteByTagID got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmDeleteByTagID.DeleteByTagIDMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ThingTagRepositoryMock) MinimockDeleteByTagIDInspect() {
	for _, e := range m.DeleteByTagIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ThingTagRepositoryMock.DeleteByTagID at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.DeleteByTagIDMock.defaultExpectation != nil && afterDeleteByTagIDCounter < 1 {
		if m.DeleteByTagIDMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ThingTagRepositoryMock.DeleteByTagID at\n%s", m.DeleteByTagIDMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ThingTagRepositoryMock.DeleteByTagID at\n%s with params: %#v", m.DeleteByTagIDMock.defaultExpectation.expectationOrigins.origin, *m.DeleteByTagIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcDeleteByTagID != nil && afterDeleteByTagIDCounter < 1 {
		m.t.Errorf("Expected call to ThingTagRepositoryMock.DeleteByTagID at\n%s", m.funcDeleteByTagIDOrigin)
	}

	if !m.DeleteByTagIDMock.invocationsDone() && afterDeleteByTagIDCounter > 0 {
		m.t.Errorf("Expected %d calls to ThingTagRepositoryMock.DeleteByTagID at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.DeleteByTagIDMock.expectedInvocations), m.DeleteByTagIDMock.expectedInvocationsOrigin, afterDeleteByTagIDCounter)
	}
}
