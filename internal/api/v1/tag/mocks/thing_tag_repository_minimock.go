...
//go:generate minimock -i github.com/dmitriygnatenko/homethings/internal/api/v1/tag.ThingTagRepository -o thing_tag_repository_minimock.go -n ThingTagRepositoryMock -p mocks
