        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <label for="formTitle" class="col-sm-3 col-form-label col-form-label-sm">
                            Название
                        </label>
                        <div class="col-sm-9">
                            <input
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" @click="submitForm">Добавить место</button>
                </div>
            </div>
        </div>
    </div>
